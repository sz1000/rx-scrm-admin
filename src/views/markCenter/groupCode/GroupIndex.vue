  ...
  <div class="enterCodeWarp">
    <div class="selectHeader">
      <el-row :gutter="24" class="firstRow">
        ...
        <el-col :span="6">
          ...
          <el-select v-model="createBy" placeholder="请选择创建人" clearable>
    ...
    <div class="enterTableWarp" v-loading='loading'>
      <el-table :data="enterTable" tooltip-effect="dark" style="width: 100%" :header-cell-style="{ background: '#FAFBFF' }">
        ...
        <el-table-column prop="total" label="添加好友数"> </el-table-column>
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template slot-scope="scope">
            ...
            <span @click="handleEdit(scope.$index, scope.row)" class="table_txt">
              编辑
            </span>
  ...
  methods: {
    ...
    downData() {
      ...
      axios({
        method: 'get',
        url:
          BASE_URL + '/user-service/exportlivecode/downloadLivecodeGroupList',
        headers: {
          token: token,
        },
        params: params,
        ...
        .then((res) => {
          if (res && this.enterTable.length > 0) {
            ...
            link.setAttribute('download', '全部群活码信息导出.xlsx')
            link.click()
            link = null
            this.loading = false
