    ...
    <div class="textarea-box">
      <section class="text-content">
        <el-input
          ...
          show-word-limit
          type="textarea"
          v-show="itemInfo.activeIndex == 'text'"
        >
        </el-input>
      </section>
      <section class="upload-box" v-show="itemInfo.activeIndex == 'image'">
        <el-upload
        ...
        <div class="adviceTxt" v-show="itemInfo.activeIndex == 'image'">
          建议上传大小不超过2MB的图片，格式支持jpeg、jpg、png
        </div>
      </section>
      <section class="pdf-box" v-show="itemInfo.activeIndex == 'pdf'">
        <div v-show="!showPdf">
          <el-upload
            class="avatar-uploader"
            action="#"
