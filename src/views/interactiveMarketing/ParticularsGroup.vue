            ...
            <ul>
              ...
              <li class="flex_baseline detail_list ">
                ...
                <div>
                  ...
                  <div class=" img_top link_warp" v-for="(item,index) in warpImgList" :key="index">
                    <div class="detail_img">
                  ...
                  <div class="link_warp " v-for="(item,index) in warpUrlList " :key="index">
                    <div>
                    ...
                    <div class="send_warp">
                      ...
                      <div class="detail_name mb-16">
                        <span
                          >所在群聊：<span
                            class="tag_names"
                            v-for="item in sendPerson.customerMassGroupEntityList"
                            :key="item.id"
                            >{{ item.name }}</span
                          ></span
                        >
                      ...
                      <div class="mb-16 flex">
                        ...
                        <div class="flex_warp">
                          <p
                            class="tag_name"
                            v-for="item in sendPerson.customerMassScreenlabelEntityList"
                            :key="item.id"
                          >
                            {{ item.name }}
                          </p>
