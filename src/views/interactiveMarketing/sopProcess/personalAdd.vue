              ...
              <div class="item">
                ...
                <div class="val">
                  ...
                  <div class="inside_box" v-for="(son,i) in item.sopContentAttachmentVOS" :key="i">
                    ...
                    <!-- <div class="share_box" v-if="son.tab == 1 ">
                                            <div>
                                              <div class="title">{{son.title}}</div>
                                              <div class="des">{{son.urlAbstract}}</div>
                                            </div>
                    ...
                    <!-- <div class="img_row" v-if="son.tab == 3">
                                            <div class="img_box">
                                                <img :src="son.url" alt="">
                                            </div>
                                            <div class="info_r">
              ...
              <div class="e_item" v-for="(item,index) in addData.sopContentAttachmentVOS" :key="index">
                ...
                <div class="val">
                  ...
                  <div class="e_line">
                    ...
                    <div class="e_val">
                      <!-- <el-radio-group > -->
                      <!-- <el-radio class="radio" v-model="item.attachmentType" label="1" @change="chaneimg(index,'img')">图片</el-radio>
                  ...
                  <div class="link_wrap" v-if="item.attachmentType == '2'">
                    <div class="input_item">
                      <el-input v-model="item.url" @blur="blurUrl" @keyup.enter.native="onSubmit"
                    ...
                    <div class="mater_content">
                      ...
                      <div class="fileSHow" v-show="item.objectName == 2">
                        ...
                        <div class="card_article">
                          <div class="content" v-show="item.objectName == 2 && item.title">
                            <div class="left">
                              <!-- <img src="../../../assets/images/pdf_image.png" alt=""> -->
                              <img :src="item.cover" alt="">
                            </div>
              ...
              if (this.id) {
                sop_edit(data).then((res) => {
                  if (res.result) {
                    ...
                    this.$router.replace(
                      '/interactivemarketing/sopProcess/personal'
                    )
                  }
                })
              } else {
