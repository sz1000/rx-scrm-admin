<template>
    <div class="detail_wrap">
        ...
        <div class="detail_row">
            <div class="item_wrap">
                <div class="line_title">个人SOP规则详情</div>
                <div class="p">规则名称：{{detail.ruleName}}</div>
                <div class="p">使用员工：{{detail.userNames}}</div>
                                ...
                                <div class="inside_box" v-for="(son,i) in item.sopContentAttachmentVOS" :key="i">
                                    ...
                                    <!-- <div class="share_link" v-else>{{son.url}}</div> -->
                                           ...
                                           <div class="share_box" v-if="son.objectName == 2 ">
                                              ...
                                              <div>
                                              <div class="title">{{son.title}}</div>
                                              <div class="des" v-if="son.fileSize != ''">{{$filterSize(son.fileSizes)}}</div>
                                            </div>
                                         </div>
                ...
                <div class="total_wrap">
                    <div class="total_box">
                        <div class="total_item">
                            <div class="num">{{detail.taskSendEmployeeCount}}</div>
                            <div class="text">任务发送成员</div>
                        </div>
                        <div class="total_item">
                            <div class="num">{{detail.taskSendCustomerCount}}</div>
                            <div class="text">任务送达客户</div>
                        </div>
                    </div>
                    <div class="total_box">
                        <div class="total_item">
                            <div class="num">{{detail.sentEmployeeCount}}</div>
                            <div class="text">已发送成员</div>
                        </div>
                        <div class="total_item">
                            <div class="num">{{detail.sentCustomerCount}}</div>
                            <div class="text">已送达客户</div>
                        </div>
                    </div>
                    <div class="total_box">
                        <div class="total_item">
                            <div class="num">{{detail.notSendEmployeeCount}}</div>
                            <div class="text">未发送成员</div>
                        </div>
                        <div class="total_item">
                            <div class="num">{{detail.notSendCustomerCount}}</div>
                            <div class="text">未送达客户</div>
                        </div>
                    </div>
                </div>
                <div class="table">
                    <el-table :data="list" :header-cell-style="{ background: '#FAFBFF',color: '#3C4353' }" style="width: 100%">
                        ...
                        <el-table-column prop="senderName" show-overflow-tooltip label="发送人"></el-table-column>
                        <el-table-column prop="customerName" show-overflow-tooltip label="客户"></el-table-column>
                        <el-table-column prop="contactName" show-overflow-tooltip label="联系人"></el-table-column>
                        <el-table-column prop="customerAddTime" label="客户添加时间" min-width="160px"></el-table-column>
                        <el-table-column prop="promptTime" label="提醒时间" min-width="160px"></el-table-column>
                        <el-table-column prop="content" show-overflow-tooltip label="发送内容名称" min-width="160px"></el-table-column>
                        <el-table-column prop="msgCount" label="发送消息数量" min-width="160px"></el-table-column>
                        <el-table-column prop="msgSendCount" label="实发消息数量" min-width="160px"></el-table-column>
        ...
        <el-dialog class="dialog_wrap" title="发送详情" :visible.sync="dialog" width="520px">
            <div class="dialog_content">
                ...
                <div class="d_line">
                    ...
                    <div class="val">{{detailData.contactName}}</div>
                </div>
                <div class="d_line">
                    <div class="label">客户添加时间：</div>
                    <div class="val">{{detailData.customerAddTime}}</div>
                </div>
                <div class="d_line">
                ...
                <el-table class="bd" :data="detailData.sopSendDetailVOS" :header-cell-style="{ color: '#3C4353' }" style="width: 100%">
                    <el-table-column type="index" label="编号" width="50"></el-table-column>
                    <el-table-column prop="attachmentName" show-overflow-tooltip label="推送内容">
                        <!-- <template slot-scope="scope">
                         ...
                         <template slot-scope="scope">
                            ...
                            <!-- <div class="column_item" v-if="!scope.row.objectName">
                           
                                <div class="val">
                                    <div class="name">{{scope.row.contactName}}</div>
