    ...
    <div class="tableWarp">
      ...
      >
        ...
        <el-table-column fixed="right" label="操作" width="220">
          <template slot-scope="scope">
            <span
              @click="particularsClick(scope.$index, scope.row)"
              class="table_txt"
              >详情</span
            >
            <!-- ||
            ...
            > -->
            <span
              @click="remindOpenClick(scope.$index, scope.row)"
              class="table_txt"
              v-if="scope.row.status != 2 && scope.row.status != 4"
              >提醒发送</span
            >
            <span
              @click="undosend(scope.row)"
              class="table_txt"
              v-if="
                scope.row.status != 2 &&
                scope.row.status != 4 &&
