  ...
  <div class="upload_box">
    <div class="warpList" v-for="(item, index) in list" :key="index">
      <ul class="radio-type">
        ...
        <li v-for="(el, i) in radioList" :key="i" @click="changeRadio(item, el)">
          <span :class="{ active: item.type == el.value }" class="defaultBorder"></span>
          <span :class="{ activeTxt: item.type == el.value }" class="defaultColor">{{ el.name }}</span>
        </li>
        <!--  -->
      ...
      <div class="textarea-box">
        ...
        <section class="link-box" v-else>
          ...
          <el-form>
            <el-form-item>
              <el-input v-model="item.val" @input="
