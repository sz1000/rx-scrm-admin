  ...
  <div class="group_warp" v-loading="loading">
    ...
    <div class="tableWarp">
      <el-table :header-cell-style="{ background: '#FAFBFF' }" :data="tableData">
        ...
        <el-table-column prop="userNum" label="任务发送成员" width="120px" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="clueNum" label="任务目标客户" width="120px" show-overflow-tooltip>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    particularsClick(index, row) {
      ...
      this.$router.push({
        path: '/interactivemarketing/ParticularsGroup',
            ...
            .then((res) => {
              ...
              this.$network
                .post('/customer-service/sendGroupMsg/createGroupMag', {
                  ...
                  groupList: [],
                  clueCustomerList: res.data.customerMassScreenEntityList,
                })
                .then((res) => {
                  console.log(res)
                })
    ...
    redactClick(index, row) {
      console.log(row)
      this.$router.push({
        path: '/detailedOperation/Clientsend',
        query: { id: row.massNo },
      })
    },
  },
