  ...
  <div class="technique_wrap">
    ...
    <div class="bottom_warp">
      <div class="group_left">
        ...
        <div class="all_group">
          <el-tree :data="treeData" :props="defaultProps" node-key="id" @node-click="handleNodeClick" :default-expanded-keys="expandedKey"
                   highlight-current :expand-on-click-node="false" :indent="15" class="showTree">
          ...
          <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" empty-text="" :header-cell-style="{ background: '#FAFBFF' }">
            ...
            <el-table-column label="话术内容" show-overflow-tooltip>
              <template slot-scope="scope">
                ...
                <div class="allNum">共{{ scope.row.contentList.length }}条</div>
              </template>
            </el-table-column>
            ...
            <el-table-column label="最后编辑时间" min-width="110px" show-overflow-tooltip>
              <template slot-scope="scope">
    ...
    <div v-if="newGroup">
      <AddNewGroup :newGroup="newGroup" :isShowOperate="isShowOperate" :addGroupVal="addGroupVal" @closeNewGroup="closeNewGroup"
                   :groupType="groupType"></AddNewGroup>
    </div>
    <div v-if="copyDialog">
