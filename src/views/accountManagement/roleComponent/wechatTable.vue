  ...
  <div class="wrap">
    <div class="table">
      <div class="one_box" v-for="(item,i) in list" :key="item.id">
        ...
        <div class="item">
          <div class="item_row" v-if="!item.ispage">
            <div class="row" v-for="(o,oi) in item.childrenList" :key="o.id">
              <div class="item menuItem">
                <el-checkbox v-model="o.checked" :indeterminate="o.isIndeterminate"
                ...
                <div class="row">
                  <div class="foure_box">
                    <el-checkbox class="btn_box" v-model="t.checked"
                                 @change="changeFun(t,w,i,oi,wi)" v-for="t in o.childrenList"
          ...
          <div class="row" v-else>
            ...
            <div class="item flex_center">
              <div class="row">
                <div class="foure_box">
                  <el-checkbox class="btn_box" v-model="t.checked" @change="changeFun(t,w,i,oi,wi)"
                               v-for="t in item.childrenList" :key="t.id">{{t.title}}</el-checkbox>
                </div>
              </div>
            </div>
          </div>
    ...
    getDetail() {
      ...
      this.$network
        ...
        .then((res) => {
          ...
          this.idList = res.data.mobileList
