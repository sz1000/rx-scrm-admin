<template>
  <div class="customWarp">
    ...
    <!-- <div v-if="addCule">
      <CustomAdd :addCule="addCule" :name="addCustomerName" @closeAddCule="closeAddCule" :commonType="type"></CustomAdd>
    </div> -->
    <div v-if="showImport">
      <ImportDialog :importVisible='showImport' @closeImport='closeImport' type='3'></ImportDialog>
    </div>
...
export default {
  ...
  methods: {
    ...
    getFiledChange() {
      ...
      console.log(this.leixingList, '---------leixingList')
    },
    optionsDouble() {
