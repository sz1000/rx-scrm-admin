                    ...
                    <el-form-item label="使用群聊：" prop="groupIdArr">
                        <el-select class="select" v-model="detail.groupIdArr" multiple placeholder="请选择群聊（可多选）">
                            <el-option
                                ...
                                :key="item.id"
                                :label="`${item.name}（${item.usersum}）群主：${item.owmerName}`"
                                :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                            ...
                            <div class="time_item">
                                ...
                                <div class="val">
                                    <el-date-picker
                                        ...
                                        v-model="detail.promptPeriodBegin"
                            ...
                            <div class="time_item">
                                ...
                                <div class="val">
                                    <el-date-picker
                                        ...
                                        v-model="detail.promptPeriodEnd"
                                        value-format="yyyy-MM-dd"
                                        type="date"
                                        placeholder="选择日期">
                                    </el-date-picker>
                                        ...
                                        <!-- <div class="share_link" v-else>{{son.url}}</div> -->
                                           <div class="share_box" v-if="son.attachmentType == 2 ">
                                            <div>
                                             ...
                                             <!-- <div class="share_box" v-if="son.tab == 2 ">
                                                <div class="line">
                                                <div class="img_box">
                                           ...
                                           <div class="share_box" v-if=" son.attachmentType == 2 && son.tab == 2">
                                            <div>
                                              <div class="title">{{son.title}}</div>
                                              <div class="des">{{son.urlAbstract}}</div>
                                            </div>
                                ...
                                <div class="val">
                                    ...
                                    <div class="e_line">
                                        ...
                                        <div class="e_val">
                                            ...
                                            <el-radio class="radio" v-model="item.attachmentType" label="3"  @change="changeRadio(index)">链接</el-radio>
                                        </div>
                                    </div>
...
import { sop_add,sop_detail,sop_edit,sop_groupList,sop_sopNameValidate } from '@/api/sop'
      ...
      //  console.log(params,'---parasm----')
       ...
       getarticle(params).then((res)=>{
        ...
        confirmFun(){   //确定添加内容 or 编辑内容
            ...
            if(this.detail.promptRule == '1'){     //周期推送
                data.promptTime = '0D-' + data.time
                data.promptTimeMsg = '配置本条规则后，每天' + data.time + '提醒群主发送消息'
            }else{
                data.promptTime = this.getPromptTime(data)
                data.promptTimeMsg = this.getPromptTime(data,'name')
            }
            let isEnclosureEmpty = false,isLink = false
        ...
        addFun(){   //新增规则确定
            ...
            this.$refs.ruleForm.validate((valid) => {
                if (valid) {
                    console.log('submit! valid');
                    if(new Date(data.promptPeriodEnd).getTime() < new Date(data.promptPeriodBegin).getTime()){
                        this.$message({message: '设定时间结束时间不能小于开始日期',duration: 2000,type:'error'})
                        return false
                    }
                            ...
                            if(this.id){
                                sop_edit(data).then(res => {
                                    if(res.result){
                                        ...
                                        this.$router.replace('/customerManagement/sopProcess/group')
                                    }
                                })
                            }else{
        ...
        editFun(i){  //编辑内容
            ...
            if(this.detail.promptRule == '1'){  //定期
                data.pushType = '1'
        ...
        getPromptTime(data,val){
            ...
            if(data.pushType == '1'){   //一天内
                ...
                if(val){
                    str = '配置本条规则后' + data.d + '天后，当日' + data.time + '提醒群主发送消息'
                }else{
