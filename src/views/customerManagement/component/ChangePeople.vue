<template>
  <div class="edit_dialog">
    <el-dialog title="变更负责人" :visible.sync="changeDialog" :before-close="dialogFormCancel" :close-on-click-modal='false' width="520px">
      <div class="rowStyle"><span>现有负责人：</span>{{people}}</div>
      <div><span style="color:red">*</span>指定负责人： <el-select v-model="region" @change="leaderChange" clearable placeholder="选择员工">
