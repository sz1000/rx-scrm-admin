<template>
  <div class="customWarp">
        ...
        <el-row type="flex" :gutter="20">
          <el-col :span="6">
            <el-form-item label="前负责人:">
              <el-select v-model="ruleForm.beBelongBy" placeholder="请选择" clearable>
    ...
    <div v-if="showImport">
      <ImportDialog :importVisible='showImport' @closeImport='closeImport' type='2'></ImportDialog>
    </div>
...
import { cluecustomer_getcluecustomerlist, getlistFiled } from '@/api/customer'
