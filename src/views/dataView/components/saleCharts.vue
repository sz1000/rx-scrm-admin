...
export default {
    ...
    data(){
        return {
            ...
            nameList: ['阶段一','阶段二','阶段三','阶段四','阶段五','阶段六','阶段七','阶段八','阶段九','阶段十','成交'],
        }
    },
    computed: {
        clientWidth(){
                ...
                series: [
                    {
                        ...
                        // [
                        //     {value: 100, name: '阶段一'},
                        //     {value: 91.67, name: '阶段二'},
                        //     {value: 83.33, name: '阶段三'},
                        //     {value: 66.67, name: '阶段四'},
                        //     {value: 58.33, name: '阶段五'},
                        //     {value: 50, name: '阶段六'},
                        //     {value: 41.67, name: '阶段七'},
                        //     {value: 25, name: '阶段八'},
                        //     {value: 20, name: '阶段九'},
                        //     {value: 16.67, name: '阶段十'},
                        //     {value: 16.67, name: '成交'},
                        // ]
                    }
                ]
    ...
    .type_box{
        ...
        .type{
            ...
            &::before{
                ...
                right: -10px;
                top: 50%;
                transform: translate(100%,-50%) scaleY(.5);
            }
            &:last-child{
                margin-bottom: 0;
            }
