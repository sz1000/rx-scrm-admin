      ...
      <div style="width: 810px">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="选择群主:" prop="region" label-width="120px">
            <el-select multiple class="group" v-model="ruleForm.region" placeholder="请选择群发员工 （可多选）" @change="groupStaff">
              <!-- <el-option label="区域一" value="shanghai"></el-option> -->
              <el-option v-for="(item, index) in groupList" :key="index" :label="item.owmerName" :value="item.chatId">
              </el-option>
            </el-select>
          </el-form-item>
