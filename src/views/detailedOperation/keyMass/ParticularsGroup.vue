    ...
    <div>
      <el-card>
        ...
        <div class="detail_warp flex_between">
          <div>
            <ul>
              ...
              <li class="detail_list">
                ...
                <span class="detail_name" v-if="massDetail.sendType == 1">立即发送</span>
                <span class="detail_name" v-if="massDetail.sendType == 2">定时发送</span>
              </li>
              <li class="detail_list">
              ...
              <li class="flex_baseline ">
                ...
                <div>
                  ...
                  <div class="flex_center img_top" v-for="item in customerMassResourcesEntityList" :key="item.id">
                    <div class="detail_img">
                      <img :src="item.ossUrl" v-if="item.ossUrl != null" alt="" />
                    </div>
              ...
              <li class="flex_baseline detail_list">
                ...
                <div>
                  ...
                  <!-- <div class="flex_center img_top link_warp" v-for="(item,index) in warpImgList" :key="index">
                    ...
                    <div class="ml-16">
                      <p class="img_name">{{item.ossObjectname}}</p>
                      <p class="img_size">27.35k</p>
                    </div>
                  </div> -->
          ...
          <div>
            <ul>
              <li class="flex_baseline detail_list">
                <div class="detail_name centwarp  mr_20">发送对象:</div>
                <div v-if="massDetail.allCustomer == 1">
                  <div>
                    ...
                    <div class="send_warp">
                      ...
                      <div class="detail_name mb-16">
                        <span>所在群聊：<span class="tag_names" v-for="item in sendPerson.customerMassGroupEntityList"
                                :key="item.id">{{ item.name }}</span></span>
                      </div>

                      <div class="mb-16 flex">
                        <p class="tite_send">客户标签：</p>
                        <div class="flex_warp">
                          <p class="tag_name" v-for="item in sendPerson.customerMassScreenlabelEntityList" :key="item.id">
                            {{ item.name }}
                          </p>
                        </div>
                      </div>
                ...
                <div v-if="massDetail.allCustomer == 2">
                  <div class="send_warp">
                    <div class="detail_name mb-16">
                      <span>群发客户：<span class="tag_names">全部客户</span></span>
                    </div>
                  </div>
                </div>
              </li>
        ...
        <div>
          ...
          <div class="flex statistics-between">
            ...
            <div class="statistics flex">
              <div class="mr-60">
                <p class="statistics_num">
                  {{ dataStatisticsvo.receiveAllNum }}
                </p>
                <p class="statistice_tite">客户接收已达上限</p>
              </div>
              <div>
                <p class="statistics_num">
                  {{ dataStatisticsvo.noReceiveAllNum || 0 }}
                </p>
                <p class="statistice_tite">客户非好友无法发送</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="flex mt-10">
        <div class="details_warp">
          ...
          <ul>
            <li class="details_list" v-for="item in userchooseEntityList" :key="item.id">
              <div class="details">
                ...
                <span class="but_details" v-if="item.sendStatus == 1">未发送</span>
        ...
        <div class="details_warp">
          ...
          <ul>
            <li class="details_list" v-for="item in customerMassScreenEntityList" :key="item.id">
              <div class="details">
